...
[1] https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/diffusion/stable_diffusion/model/unet.py
---
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        # Adjust number of base channels and size of conditional embedding to be a multiple
        # of 32. Necessary for GroupNorm32
        channels = closest_multiple(channels, 32)
        d_cond = closest_multiple(d_cond, 32)
        ...
        self.cond_embed = nn.Sequential(
            nn.Conv2d(cond_in_channels, d_cond, kernel_size=1, stride=1, padding=0),
            nn.SiLU(),
            nn.Conv2d(d_cond, d_cond, kernel_size=1, stride=1, padding=0),
        )
